...
<script lang="ts">
	...
	export default class VideoConverter extends Vue {
		...
		private convertToVideo(images: ImageInfo[], mimeType: string): Promise<Blob> {
			...
			const animate = () => {
				...
				context.drawImage(images[imageIndex++].canvas!, 0, 0, this.width, this.height)
